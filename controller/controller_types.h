...
const QString kKeyNames[] = {
    "kLeft",       "kRight",      "kJump",       "kShowInventory",
    "kInventory0", "kInventory1", "kInventory2", "kInventory3",
    "kInventory4", "kInventory5", "kInventory6", "kInventory7",
    "kInventory8", "kInventory9", "kExit",
};
